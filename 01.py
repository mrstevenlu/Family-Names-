...
for i in range(1,100):
    ...
    if is_boy == 1:
        if one_or_two ==1:
             picked_word =random.choice(boys_given_words1)
        else:
             picked_word =random.choice(boys_given_words2)

    else:
        if one_or_two ==1:
             picked_word =random.choice(girls_given_words1)
        else:
             picked_word =random.choice(girls_given_words2)


                 #print("\n now given name" is %s%(picked_word))

    full_name=one_name+picked_word
